...
namespace K4AdotNet.Record
{
    ...
    internal static class NativeApi
    {
        ...
        /// </remarks>
        [DllImport(Sdk.SENSOR_DLL_NAME, EntryPoint = "k4a_record_create", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, BestFitMapping = false, ThrowOnUnmappableChar = true)]
        ...
        /// recording location.
        /// </remarks>
        [DllImport(Sdk.SENSOR_DLL_NAME, EntryPoint = "k4a_record_add_tag", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, BestFitMapping = false, ThrowOnUnmappableChar = true)]
        ...
        /// <param name="recordingHandle">The handle of a new recording, obtained by <see cref="RecordCreate(string, NativeHandles.DeviceHandle, Sensor.DeviceConfiguration, out NativeHandles.RecordHandle)"/>.</param>
        /// <returns><see cref="NativeCallResults.Result.Succeeded"/> is returned on success.</returns>
        [DllImport(Sdk.SENSOR_DLL_NAME, EntryPoint = "k4a_record_add_imu_track", CallingConvention = CallingConvention.Cdecl)]
        public static extern NativeCallResults.Result RecordAddTag(NativeHandles.RecordHandle recordingHandle);
        ...
        /// <param name="recordingHandle">The handle of a new recording, obtained by <see cref="RecordCreate(string, NativeHandles.DeviceHandle, Sensor.DeviceConfiguration, out NativeHandles.RecordHandle)"/>.</param>
        /// <returns><see cref="NativeCallResults.Result.Succeeded"/> is returned on success.</returns>
        [DllImport(Sdk.SENSOR_DLL_NAME, EntryPoint = "k4a_record_write_header", CallingConvention = CallingConvention.Cdecl)]
        ...
        /// </remarks>
        [DllImport(Sdk.SENSOR_DLL_NAME, EntryPoint = "k4a_record_write_capture", CallingConvention = CallingConvention.Cdecl)]
        ...
        /// written capture.
        /// </remarks>
        [DllImport(Sdk.SENSOR_DLL_NAME, EntryPoint = "k4a_record_write_imu_sample", CallingConvention = CallingConvention.Cdecl)]
        ...
        /// not guaranteed.
        /// </remarks>
        [DllImport(Sdk.SENSOR_DLL_NAME, EntryPoint = "k4a_record_flush", CallingConvention = CallingConvention.Cdecl)]
