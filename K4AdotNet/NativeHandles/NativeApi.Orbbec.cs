...
namespace K4AdotNet.NativeHandles
{
    partial class NativeApi
    {
        public static class Orbbec
        {
            ...
            [DllImport(Sdk.Orbbec.SENSOR_DLL_NAME, EntryPoint = "k4a_capture_reference", CallingConvention = CallingConvention.Cdecl)]
            ...
            [DllImport(Sdk.Orbbec.SENSOR_DLL_NAME, EntryPoint = "k4a_capture_release", CallingConvention = CallingConvention.Cdecl)]
            ...
            /// </remarks>
            [DllImport(Sdk.Orbbec.SENSOR_DLL_NAME, EntryPoint = "k4a_image_reference", CallingConvention = CallingConvention.Cdecl)]
            ...
            /// not access the object after its reference is released.
            /// </remarks>
            [DllImport(Sdk.Orbbec.SENSOR_DLL_NAME, EntryPoint = "k4a_image_release", CallingConvention = CallingConvention.Cdecl)]
            ...
            [DllImport(Sdk.Orbbec.SENSOR_DLL_NAME, EntryPoint = "k4a_transformation_destroy", CallingConvention = CallingConvention.Cdecl)]
            ...
            [DllImport(Sdk.Orbbec.SENSOR_DLL_NAME, EntryPoint = "k4a_device_close", CallingConvention = CallingConvention.Cdecl)]
            ...
            [DllImport(Sdk.Orbbec.SENSOR_DLL_NAME, EntryPoint = "k4a_depth_engine_helper_release", CallingConvention = CallingConvention.Cdecl)]
            public static extern void DepthEngineHelperRelease(IntPtr depthEngineHandle);
            ...
            [DllImport(Sdk.Orbbec.RECORD_DLL_NAME, EntryPoint = "k4a_record_close", CallingConvention = CallingConvention.Cdecl)]
            ...
            [DllImport(Sdk.Orbbec.RECORD_DLL_NAME, EntryPoint = "k4a_playback_close", CallingConvention = CallingConvention.Cdecl)]
            ...
            [DllImport(Sdk.Orbbec.RECORD_DLL_NAME, EntryPoint = "k4a_playback_data_block_release", CallingConvention = CallingConvention.Cdecl)]
